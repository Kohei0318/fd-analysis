# fd_plot_filtered_peaks_y2000_fixed_origin_with_offset_in_name.py
...
for file_path in txt_files:
    ...
    # y_offsetを整数に丸めてファイル名に含める
    y_offset_int = int(round(y_offset))
    out_png = f"{out_name}_yoffset{y_offset_int}pN_aligned.png"
    plt.savefig(out_png)
    plt.close()
